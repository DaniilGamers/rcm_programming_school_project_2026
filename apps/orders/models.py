...
class OrdersModel(BaseModel):
    ...
    phone = models.CharField(max_length=12, null=True, validators=(V.MinLengthValidator(1),))
    age = models.IntegerField(validators=(V.MinLengthValidator(1),))
    ...
    sum = models.IntegerField(null=True, validators=(V.MinLengthValidator(9),))
    alreadyPaid = models.IntegerField(null=True, validators=(V.MinLengthValidator(9),))
